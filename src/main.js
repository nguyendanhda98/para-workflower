  ...
  'node_modules/obsidian-dataview/lib/index.js'(exports) {
    ...
    var Info = class {
      ...
      static monthsFormat(
        ...
        return (locObj || Locale.create(locale, numberingSystem, outputCalendar)).months(
          length,
          true,
        );
      }
    ...
    function oneOf(strings, startIndex) {
      if (strings === null) {
        ...
        return {
          ...
          deser: ([s2]) =>
            strings.findIndex((i) => stripInsensitivities(s2) === stripInsensitivities(i)) +
            startIndex,
        };
      }
    }
      ...
      !(function (n2, t) {
        ...
        return (function (n2) {
          ...
          return (
            (r.m = n2),
            (r.c = t),
            (r.d = function (n3, t2, e) {
              r.o(n3, t2) ||
                Object.defineProperty(n3, t2, { configurable: false, enumerable: true, get: e });
            }),
            (r.r = function (n3) {
          ...
          function (n2, t, r) {
            ...
            function f(n3, t2) {
              ...
              return (
                o(n3, function () {
                  var n4;
                  r2 = {
                    v: (r2.v << 1) | ((n4 = r2.buf), n4[0] >> 7),
                    buf: (function (n5) {
                      var t3 = i(
                        function (n6, t4, r3, e2) {
                          return n6.concat(
                            r3 === e2.length - 1
                              ? Buffer.from([t4, 0]).readUInt16BE(0)
                              : e2.readUInt16BE(r3),
                          );
                        },
                        [],
            ...
            function h(n3, t2) {
              return new e(function (r2, e2) {
                return (
                  s2(),
                  e2 + t2 > r2.length
                    ? x(e2, t2 + ' bytes for ' + n3)
                    : b(e2 + t2, r2.slice(e2, e2 + t2))
                );
              });
            }
            function p(n3, t2) {
            ...
            function d(n3) {
              return (
                p('uintBE', n3),
                h('uintBE(' + n3 + ')', n3).map(function (t2) {
            ...
            function v(n3) {
              return (
                p('uintLE', n3),
                h('uintLE(' + n3 + ')', n3).map(function (t2) {
            ...
            function x(n3, t2) {
              return (
                E(t2) || (t2 = [t2]),
                { status: false, index: -1, value: null, furthest: n3, expected: t2 }
              );
            }
            function B(n3, t2) {
              if (!t2) return n3;
              ...
              var r2 =
                n3.furthest === t2.furthest
                  ? (function (n4, t3) {
                      ...
                      return c2.sort(), c2;
                    })(n3.expected, t2.expected)
                  : t2.expected;
              return {
                status: n3.status,
                index: n3.index,
                value: n3.value,
                furthest: t2.furthest,
                expected: r2,
              };
            }
            var j = {};
            function S(n3, t2) {
              ...
              var a2 = e2 + u2,
                f2 = t2 - o2;
              return (
                (r2[t2] = { line: a2, lineStart: o2 }), { offset: t2, line: a2 + 1, column: f2 + 1 }
              );
            }
            function _(n3) {
              if (!y(n3)) throw new Error('not a parser: ' + n3);
            }
            function L(n3, t2) {
            ...
            function D(n3, t2) {
              ...
              if (w(n3)) {
                ...
                (o2 = (function (n4) {
                  return 0 === n4.from && 1 === n4.to
                    ? { from: n4.from, to: n4.to }
                    : { from: n4.from / I, to: Math.floor(n4.to / I) };
                })(d2)),
                  (e2 = h2 / I),
                  (r2 = 3 * p2),
                  p2 >= 4 && (r2 += 1),
                  ...
                  (u2 = a(function (n4) {
                    return n4.length <= 4
                      ? n4.join(' ')
                      : n4.slice(0, 4).join(' ') + '  ' + n4.slice(4).join(' ');
                  }, v2)),
                  (f2 = (8 * (o2.to > 0 ? o2.to - 1 : o2.to)).toString(16).length) < 2 && (f2 = 2);
              } else {
                var g2 = n3.split(/\r\n|[\n\r\u2028\u2029]/);
                (r2 = c2.column - 1),
                  (e2 = c2.line - 1),
                  (o2 = W(e2, q, A, g2.length)),
                  (u2 = g2.slice(o2.from, o2.to)),
                  (f2 = o2.to.toString().length);
              }
              var m2 = e2 - o2.from;
              return (
                w(n3) &&
                  (f2 = (8 * (o2.to > 0 ? o2.to - 1 : o2.to)).toString(16).length) < 2 &&
                  (f2 = 2),
                i(
                  function (t3, e3, u3) {
                    var i2,
                    ...
                    return (
                      (i2 = w(n3)
                        ? U((8 * (o2.from + u3)).toString(16), f2, '0')
                        : U((o2.from + u3 + 1).toString(), f2, ' ')),
                      [].concat(
                        t3,
                        [c3 + i2 + ' | ' + e3],
                        a2 ? [z + R(' ', f2) + ' | ' + U('', r2, ' ') + R('^', l3)] : [],
            ...
            function J() {
              ...
              return (
                k(t2),
                C.apply(null, n3).map(function (n4) {
            ...
            function T() {
              ...
              return e(function (t3, r3) {
                for (var e2, u2 = 0; u2 < n3.length; u2 += 1)
                  if ((e2 = B(n3[u2]._(t3, r3), e2)).status) return e2;
                return e2;
              });
            }
            function V(n3, t2) {
            ...
            function H(n3, t2) {
              return (
                _(n3),
                _(t2),
                J(n3, t2.then(n3).many(), function (n4, t3) {
                  return [n4].concat(t3);
                })
              );
            }
            ...
            function nn(n3) {
              return (
                ...
                e(function (t2, r2) {
                  var e2 = L(t2, r2);
                  return r2 < t2.length && n3(e2)
                    ? b(r2 + 1, e2)
                    : x(r2, 'a character/byte matching ' + n3);
                })
              );
            }
            function tn(n3, t2) {
            ...
            (u.parse = function (n3) {
              ...
              var t2,
                r2 = this.skip(an)._(n3, 0);
              return (
                (t2 = r2.status
                  ? { status: true, value: r2.value }
                  : { status: false, index: S(n3, r2.furthest), expected: r2.expected }),
                delete j[n3],
                t2
              );
            }),
            ...
            (e.all = on),
              ...
              (e.any = un),
              (e.cr = dn),
              (e.createLanguage = function (n3) {
                var t2 = {};
                for (var r2 in n3)
                  ({}).hasOwnProperty.call(n3, r2) &&
                    (function (r3) {
                      t2[r3] = tn(function () {
                        return n3[r3](t2);
                      });
              ...
              (e.seqObj = function () {
                for (
                  var n3,
                    t2 = {},
                    r2 = 0,
                    u2 = ((n3 = arguments), Array.prototype.slice.call(n3)),
                    o2 = u2.length,
                    i2 = 0;
                  i2 < o2;
                  i2 += 1
                ...
                return e(function (n4, t3) {
                  for (var r3, e2 = {}, i3 = 0; i3 < o2; i3 += 1) {
                    ...
                    if (
                      (E(u2[i3])
                        ? ((a3 = u2[i3][0]), (f3 = u2[i3][1]))
                        : ((a3 = null), (f3 = u2[i3])),
                      !(r3 = B(f3._(n4, t3), r3)).status)
                    )
                      return r3;
              ...
              (e.Binary = {
                ...
                bitSeqObj: function (n3) {
                  ...
                  var t2 = {},
                    ...
                    e2 = a(function (n4) {
                      if (E(n4)) {
                        ...
                        if (2 !== e3.length)
                          throw new Error(
                            '[' + e3.join(', ') + '] should be length 2, got length ' + e3.length,
                          );
                  ...
                  if (r2 < 1)
                    throw new Error(
                      'bitSeqObj expects at least one named pair, got [' + n3.join(', ') + ']',
                    );
    ...
    parsimmon_umd_minExports
      .alt(
        parsimmon_umd_minExports.regex(new RegExp(emojiRegex(), '')),
        parsimmon_umd_minExports.regex(/[0-9\p{Letter}_-]+/u).map((str) => str.toLocaleLowerCase()),
        parsimmon_umd_minExports.whitespace.map((_) => '-'),
        parsimmon_umd_minExports.any.map((_) => ''),
      )
      .many()
      .map((result) => result.join(''));
    var HEADER_CANONICALIZER = parsimmon_umd_minExports
      .alt(
        parsimmon_umd_minExports.regex(new RegExp(emojiRegex(), '')),
        parsimmon_umd_minExports.regex(/[0-9\p{Letter}_-]+/u),
        parsimmon_umd_minExports.whitespace.map((_) => ' '),
        parsimmon_umd_minExports.any.map((_) => ' '),
      )
      .many()
      ...
      function compareValue(val1, val2, linkNormalizer) {
        ...
        switch (wrap1.type) {
          ...
          case 'link':
            ...
            let normalize =
              linkNormalizer !== null && linkNormalizer !== void 0 ? linkNormalizer : (x) => x;
            ...
            return ((_a = link1.subpath) !== null && _a !== void 0 ? _a : '').localeCompare(
      ...
      obsidianLink() {
        ...
        if (this.type == 'header')
          return (
            escaped +
            '#' +
            ((_a = this.subpath) === null || _a === void 0 ? void 0 : _a.replace('|', '\\|'))
          );
        if (this.type == 'block')
          return (
            escaped +
            '#^' +
            ((_b = this.subpath) === null || _b === void 0 ? void 0 : _b.replace('|', '\\|'))
          );
        else return escaped;
      }
    ...
    function createBinaryParser(child, sep, combine) {
      return parsimmon_umd_minExports.seqMap(
        ...
        parsimmon_umd_minExports
          .seq(
            parsimmon_umd_minExports.optWhitespace,
            sep,
            parsimmon_umd_minExports.optWhitespace,
            child,
          )
    ...
    var EXPRESSION = parsimmon_umd_minExports.createLanguage({
      ...
      string: (q) =>
        parsimmon_umd_minExports
          ...
          .then(
            parsimmon_umd_minExports
              .alt(q.escapeCharacter, parsimmon_umd_minExports.noneOf('"\\'))
              .atLeast(0)
      ...
      tag: (_) =>
        parsimmon_umd_minExports
          .seqMap(
            parsimmon_umd_minExports.string('#'),
            parsimmon_umd_minExports
              .alt(
                parsimmon_umd_minExports
                  .regexp(/[^\u2000-\u206F\u2E00-\u2E7F'!"#$%&()*+,.:;<=>?@^`{|}~\[\]\\\s]/)
        ...
        parsimmon_umd_minExports
          .seqMap(
            parsimmon_umd_minExports.alt(
              parsimmon_umd_minExports.regexp(/\p{Letter}/u),
              parsimmon_umd_minExports.regexp(EMOJI_REGEX).desc('text'),
            ),
            parsimmon_umd_minExports
              .alt(
                parsimmon_umd_minExports.regexp(/[0-9\p{Letter}_-]/u),
                parsimmon_umd_minExports.regexp(EMOJI_REGEX).desc('text'),
              )
              .many(),
      ...
      embedLink: (q) =>
        parsimmon_umd_minExports
          .seqMap(parsimmon_umd_minExports.string('!').atMost(1), q.link, (p, l2) => {
            if (p.length > 0) l2.embed = true;
            return l2;
          })
          .desc('file link'),
      ...
      rootDate: (_) =>
        parsimmon_umd_minExports
          .seqMap(
            parsimmon_umd_minExports.regexp(/\d{4}/),
            parsimmon_umd_minExports.string('-'),
            parsimmon_umd_minExports.regexp(/\d{2}/),
            (year, _2, month) => {
      ...
      date: (q) =>
        chainOpt(
          q.rootDate,
          (ym) =>
            parsimmon_umd_minExports.seqMap(
              parsimmon_umd_minExports.string('-'),
              parsimmon_umd_minExports.regexp(/\d{2}/),
          ...
          (ymd) =>
            parsimmon_umd_minExports.seqMap(
              parsimmon_umd_minExports.string('T'),
              parsimmon_umd_minExports.regexp(/\d{2}/),
          ...
          (ymdhms) =>
            parsimmon_umd_minExports.alt(
              parsimmon_umd_minExports.seqMap(
                parsimmon_umd_minExports.string('.'),
                parsimmon_umd_minExports.regexp(/\d{3}/),
                (_, millisecond) => ymdhms.set({ millisecond: Number.parseInt(millisecond) }),
              ),
          ...
          (dt) =>
            parsimmon_umd_minExports.alt(
              parsimmon_umd_minExports.seqMap(
                parsimmon_umd_minExports.string('+').or(parsimmon_umd_minExports.string('-')),
                parsimmon_umd_minExports.regexp(/\d{1,2}(:\d{2})?/),
                (pm, hr) => dt.setZone('UTC' + pm + hr, { keepLocalTime: true }),
              ),
              parsimmon_umd_minExports.seqMap(parsimmon_umd_minExports.string('Z'), () =>
                dt.setZone('utc', { keepLocalTime: true }),
              ),
              parsimmon_umd_minExports.seqMap(
                parsimmon_umd_minExports.string('['),
                parsimmon_umd_minExports.regexp(/[0-9A-Za-z+-\/]+/u),
                parsimmon_umd_minExports.string(']'),
      ...
      duration: (q) =>
        parsimmon_umd_minExports
          .seqMap(q.number, parsimmon_umd_minExports.optWhitespace, q.durationType, (count, _, t) =>
            DURATION_TYPES[t].mapUnits((x) => x * count),
          )
          .sepBy1(
            parsimmon_umd_minExports
              .string(',')
              .trim(parsimmon_umd_minExports.optWhitespace)
              .or(parsimmon_umd_minExports.optWhitespace),
          )
      ...
      csvSource: (q) =>
        parsimmon_umd_minExports.seqMap(
          parsimmon_umd_minExports.string('csv(').skip(parsimmon_umd_minExports.optWhitespace),
          q.string,
          parsimmon_umd_minExports.string(')'),
      ...
      linkOutgoingSource: (q) =>
        parsimmon_umd_minExports.seqMap(
          parsimmon_umd_minExports.string('outgoing(').skip(parsimmon_umd_minExports.optWhitespace),
          q.link,
          parsimmon_umd_minExports.string(')'),
        ...
        q.identifier
          .chain((r) => {
            if (KEYWORDS.includes(r.toUpperCase())) {
              return parsimmon_umd_minExports.fail(
                'Variable fields cannot be a keyword (' + KEYWORDS.join(' or ') + ')',
              );
            } else {
      ...
      dateField: (q) =>
        parsimmon_umd_minExports
          .seqMap(
            parsimmon_umd_minExports.string('date('),
            parsimmon_umd_minExports.optWhitespace,
            q.datePlus,
            parsimmon_umd_minExports.optWhitespace,
            parsimmon_umd_minExports.string(')'),
      ...
      durationField: (q) =>
        parsimmon_umd_minExports
          .seqMap(
            parsimmon_umd_minExports.string('dur('),
            parsimmon_umd_minExports.optWhitespace,
            q.duration,
            parsimmon_umd_minExports.optWhitespace,
            parsimmon_umd_minExports.string(')'),
      ...
      listField: (q) =>
        q.field
          ...
          .wrap(
            parsimmon_umd_minExports.string('[').skip(parsimmon_umd_minExports.optWhitespace),
            parsimmon_umd_minExports.optWhitespace.then(parsimmon_umd_minExports.string(']')),
          )
          .map((l2) => Fields.list(l2))
          .desc("list ('[1, 2, 3]')"),
      objectField: (q) =>
        parsimmon_umd_minExports
          .seqMap(
            q.identifier.or(q.string),
            parsimmon_umd_minExports.string(':').trim(parsimmon_umd_minExports.optWhitespace),
            q.field,
            (name, _sep, value) => {
              return { name, value };
            },
      ...
      indexField: (q) =>
        parsimmon_umd_minExports.seqMap(
          q.atomField,
          parsimmon_umd_minExports.alt(q.dotPostfix, q.indexPostfix, q.functionPostfix).many(),
          (obj, postfixes) => {
            let result = obj;
      ...
      negatedField: (q) =>
        parsimmon_umd_minExports
          .seqMap(parsimmon_umd_minExports.string('!'), q.indexField, (_, field) =>
            Fields.negate(field),
          )
          .desc('negated field'),
      parensField: (q) =>
      ...
      binaryCompareField: (q) =>
        createBinaryParser(q.binaryPlusMinusField, q.binaryCompareOp, Fields.binaryOp),
      binaryBooleanField: (q) =>
        createBinaryParser(q.binaryCompareField, q.binaryBooleanOp, Fields.binaryOp),
    ...
    function precededByWhitespaceIfNotEof(if_eof, parser) {
      return parsimmon_umd_minExports.eof
        .map(if_eof)
        .or(parsimmon_umd_minExports.whitespace.then(parser));
    }
    var QUERY_LANGUAGE = parsimmon_umd_minExports.createLanguage({
      // Simple atom parsing, like words, identifiers, numbers.
      queryType: (q) =>
        parsimmon_umd_minExports
          .alt(parsimmon_umd_minExports.regexp(/TABLE|LIST|TASK|CALENDAR/i))
          .map((str) => str.toLowerCase())
          .desc("query type ('TABLE', 'LIST', 'TASK', or 'CALENDAR')"),
      explicitNamedField: (q) =>
        parsimmon_umd_minExports.seqMap(
          EXPRESSION.field.skip(parsimmon_umd_minExports.whitespace),
          parsimmon_umd_minExports.regexp(/AS/i).skip(parsimmon_umd_minExports.whitespace),
      ...
      sortField: (q) =>
        parsimmon_umd_minExports.seqMap(
          EXPRESSION.field.skip(parsimmon_umd_minExports.optWhitespace),
          parsimmon_umd_minExports.regexp(/ASCENDING|DESCENDING|ASC|DESC/i).atMost(1),
          (field, dir) => {
        ...
        q.queryType
          .chain((type) => {
            switch (type) {
                ...
                return precededByWhitespaceIfNotEof(
                  ...
                  parsimmon_umd_minExports.seqMap(
                    parsimmon_umd_minExports
                      ...
                      .atMost(1),
                    parsimmon_umd_minExports.sepBy(
                      q.namedField,
                      parsimmon_umd_minExports
                        .string(',')
                        .trim(parsimmon_umd_minExports.optWhitespace),
              ...
              case 'list':
                return precededByWhitespaceIfNotEof(
                  () => ({ type, format: void 0, showId: true }),
                  parsimmon_umd_minExports.seqMap(
                    parsimmon_umd_minExports
                      .regexp(/WITHOUT\s+ID/i)
                      .skip(parsimmon_umd_minExports.optWhitespace)
              ...
              case 'calendar':
                return parsimmon_umd_minExports.whitespace.then(
                  parsimmon_umd_minExports.seqMap(q.namedField, (field) => {
                    return {
                      type,
                      showId: true,
                      field,
      ...
      fromClause: (q) =>
        parsimmon_umd_minExports.seqMap(
          parsimmon_umd_minExports.regexp(/FROM/i),
          parsimmon_umd_minExports.whitespace,
          EXPRESSION.source,
          (_1, _2, source) => source,
        ),
      whereClause: (q) =>
        parsimmon_umd_minExports
          .seqMap(
            parsimmon_umd_minExports.regexp(/WHERE/i),
            parsimmon_umd_minExports.whitespace,
            EXPRESSION.field,
            (where, _, field) => {
      ...
      sortByClause: (q) =>
        parsimmon_umd_minExports
          .seqMap(
            parsimmon_umd_minExports.regexp(/SORT/i),
            parsimmon_umd_minExports.whitespace,
            q.sortField.sepBy1(
              parsimmon_umd_minExports.string(',').trim(parsimmon_umd_minExports.optWhitespace),
            ),
      ...
      limitClause: (q) =>
        parsimmon_umd_minExports
          .seqMap(
            parsimmon_umd_minExports.regexp(/LIMIT/i),
            parsimmon_umd_minExports.whitespace,
            EXPRESSION.field,
            (limit, _1, field) => {
      ...
      flattenClause: (q) =>
        parsimmon_umd_minExports
          .seqMap(
            parsimmon_umd_minExports.regexp(/FLATTEN/i).skip(parsimmon_umd_minExports.whitespace),
            q.namedField,
            (_, field) => {
      ...
      groupByClause: (q) =>
        parsimmon_umd_minExports
          .seqMap(
            parsimmon_umd_minExports.regexp(/GROUP BY/i).skip(parsimmon_umd_minExports.whitespace),
            q.namedField,
            (_, field) => {
      ...
      query: (q) =>
        parsimmon_umd_minExports.seqMap(
          q.headerClause.trim(parsimmon_umd_minExports.optWhitespace),
          q.fromClause.trim(parsimmon_umd_minExports.optWhitespace).atMost(1),
          q.clause.trim(parsimmon_umd_minExports.optWhitespace).many(),
          (header, from, clauses) => {
            return {
              header,
...
var CreateProjectModal = class extends import_obsidian.Modal {
  ...
  onOpen() {
    ...
    this.projectNameSetting = new import_obsidian.Setting(contentEl)
      .setName('Name')
      .addText((text) =>
        text.onChange((value) => {
    ...
    this.areaNameSetting = new import_obsidian.Setting(contentEl).setName('Area').addText((text) =>
      text.onChange((value) => {
    ...
    this.submitControl = new import_obsidian.Setting(contentEl).addButton((btn) =>
      btn
...
async function createProject(app, settings, properties) {
  ...
  const project =
    projects.find((project2) => project2.basename.toLowerCase() === name.toLowerCase()) || null;
  ...
  const templatePath = (0, import_obsidian.normalizePath)(
    [templatesFolder, `${projectTemplateName}.md`].join('/'),
  );
...
var SettingTab = class extends import_obsidian2.PluginSettingTab {
  ...
  display() {
    ...
    new import_obsidian2.Setting(containerEl)
      .setName('User folder structure for projects')
      .setDesc('Create project folders instead of using single project file.')
      .addToggle((toggle) =>
        toggle.setValue(this.plugin.settings.useFolderStructure).onChange(async (value) => {
    ...
    new import_obsidian2.Setting(containerEl)
      .setName('Enable area companion folder')
      .setDesc('Folder name `_<name_of_area>` which contains directly related notes to this area.')
      .addToggle((toggle) =>
        toggle.setValue(this.plugin.settings.useCompanionDir).onChange(async (value) => {
...
var CreateAreaModal = class extends import_obsidian3.Modal {
  ...
  onOpen() {
    ...
    const areaNameSetting = new import_obsidian3.Setting(contentEl)
      .setName('Name')
      .addText((text) =>
        text.onChange((value) => {
          if (containsInvalidCharacters(value)) {
    ...
    areaNameSetting.descEl.hide();
    const submit = new import_obsidian3.Setting(contentEl).addButton((btn) =>
      btn
        .setButtonText('Submit')
        .setCta()
        .onClick(() => {
...
async function createArea(app, settings, properties) {
  ...
  const templateTFile = app.vault.getAbstractFileByPath(
    (0, import_obsidian3.normalizePath)(templateFile),
  );
  if (!templateTFile) {
...
// Da Nguyen code.
// Create area without open file after create
async function createArea2(app, settings, properties) {
  if (!properties.name) {
    new import_obsidian3.Notice('The area needs a name!');
    return Promise.reject();
  }
  ...
  if (templateTFile instanceof import_obsidian3.TFile) {
    ...
    if (!tFile || !(tFile instanceof import_obsidian3.TFile)) {
      await app.vault.create(file, templateContent);
    }
  }
}
...
var CreateResourceModal = class extends import_obsidian4.Modal {
  ...
  onOpen() {
    ...
    const resourceNameSetting = new import_obsidian4.Setting(contentEl)
      .setName('Name')
      .addText((text) =>
        text.onChange((value) => {
          if (containsInvalidCharacters(value)) {
    ...
    resourceNameSetting.descEl.hide();
    const submit = new import_obsidian4.Setting(contentEl).addButton((btn) =>
      btn
        .setButtonText('Submit')
        .setCta()
        .onClick(() => {
...
async function createResource(app, settings, properties) {
  ...
  const templateTFile = app.vault.getAbstractFileByPath(
    (0, import_obsidian4.normalizePath)(templateFile),
  );
  if (!templateTFile) {
...
async function archiveArea(app, archivePath, file) {
  ...
  const companionFolder = app.vault.getAbstractFileByPath(
    (0, import_obsidian5.normalizePath)(companionFolderPath),
  );
  await app.vault.createFolder(destBasePath);
  await app.fileManager.renameFile(
    file,
    (0, import_obsidian5.normalizePath)([destBasePath, file.name].join('/')),
  );
...
async function restore(app, settings, file) {
  ...
  try {
    if (
      ((_a = file.parent) == null ? void 0 : _a.path) == null ||
      !file.parent.path.contains(settings.archivePath)
    ) {
...
async function restoreArea(app, areasPath, file) {
  ...
  const areaCompanionArchive = (0, import_obsidian6.normalizePath)(
    [areaArchiveBase, `_${file.basename.toLowerCase()}`].join('/'),
  );
  const areaRestorePath = (0, import_obsidian6.normalizePath)([areasPath, file.name].join('/'));
  const areaCompanionRestorePath = (0, import_obsidian6.normalizePath)(
    [areasPath, `_${file.basename.toLowerCase()}`].join('/'),
  );
...
var RestoreParaItemModal = class extends import_obsidian7.SuggestModal {
  ...
  renderSuggestion(item, el) {
    ...
    container.createEl('div', {
      text: (_a = item.type) == null ? void 0 : _a.toString(),
      cls: 'para__item__type',
    });
  }
      ...
      callback: () => {
        ...
        if (file !== null) {
          archive(this.app, this.settings, file)
            ...
            .catch((error2) => {
              console.error(
                '[PARA Workflower] An error occurred during archiving:',
                error2.message,
              );
